	...
	<table border="1" width="100%">
		...
		<td><h2 align="center"><font face="Garamond"> Agricultural Bangladesh </font></h2><br>
			...
			<td width="80%" colspan="2">
				<h1 align="center"><font face="Garamond" color="blue">Customer Feedback</font></h1>
				<h4 align="right">
        ...
        <a href="News & Info.php">News & Info</a><br>
			...
			<td>
				...
				<form method="post" onsubmit="return validate();" action="../Controller/Customer Feedback.php">
