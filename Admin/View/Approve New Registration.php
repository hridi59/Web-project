<?php
	...
	require_once('../Model/approvenewregistrationModel.php');
	$result = AllEmployees();
...
<html>
<head>
	<title>Approve New Registration</title>
</head>
<body>
	...
	<table border="1" width="100%">
		<tr height="100px">
			...
			<td width="80%" colspan="2">
				<h1 align="center"><font face="Garamond" color="blue">Approve New Registration</font></h1>
				<h4 align="right">
        ...
        <a href="News & Info.php">News & Info</a><br>
			...
			<td>
				<h3>Approve New Registration:</h3>
