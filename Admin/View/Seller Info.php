	...
	<table border="1" width="100%">
		<tr height="100px">
			...
			<td width="80%" colspan="2">
				<h1 align="center"><font face="Garamond" color="blue">Seller Information</font></h1>
				<h4 align="right">
        ...
        <a href="News & Info.php">News & Info</a><br>
			...
			<td>
				...
				<form method="post" name="AddSeller" onsubmit="return validate();" action="../Controller/seller.php">
					Name:
